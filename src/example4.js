    ...
    return (
      <Accordion styled style={{ width: "300px" }}>
        ...
        <Accordion.Content active={activeIndex === 1}>
          ...
          <List bulleted>
            <List.Item>He's a dick</List.Item>
            <List.Item>He probably murdered someone</List.Item>
            <List.Item>He's wearing white after labor day</List.Item>
          </List>
        </Accordion.Content>
        ...
        <Accordion.Content active={activeIndex === 2}>
          ...
          <List bulleted>
            ...
            <List.Item>She ran over my mailbox</List.Item>
            <List.Item>She rewears socks</List.Item>
          </List>
        </Accordion.Content>
      </Accordion>
    );
